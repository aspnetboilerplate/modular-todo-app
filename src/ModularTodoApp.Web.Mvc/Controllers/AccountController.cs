...
using ModularTodoApp.Identity;
using ModularTodoApp.MultiTenancy;
using ModularTodoApp.Sessions;
using ModularTodoApp.Web.Models.Account;
using ModularTodoApp.Web.Views.Shared.Components.TenantChange;

namespace ModularTodoApp.Web.Controllers
{
    public class AccountController : ModularTodoAppControllerBase
    {
